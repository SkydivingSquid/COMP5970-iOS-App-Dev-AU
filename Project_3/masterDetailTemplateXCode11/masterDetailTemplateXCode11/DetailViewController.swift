...
class DetailViewController: UIViewController {
    ...
    func configureView() {
        detailDescriptionTextField.text = masterController.tasks[masterController.selectedItem]
        detailItemsTextField.text = masterController.TaskName[masterController.selectedItem]
    }
    ...
    @objc func saveButton(_ sender: Any) {
        ...
        if(detailDescriptionTextField!.text == "") {
            ...
            masterController.tasks[masterController.selectedItem] = "New Item"
            masterController.TaskName[masterController.selectedItem] = detailItemsTextField!.text ?? ""
        ...
        masterController.tasks[masterController.selectedItem] = detailDescriptionTextField!.text!
        masterController.TaskName[masterController.selectedItem] = detailItemsTextField!.text ?? ""
        }
        performSegue(withIdentifier:"goBack", sender: self )
